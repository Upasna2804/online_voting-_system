...
void posi_vote(){
	...
	printf("3.MR.OLLY\n");
	printf("4.MS.KANIKA\n");
	printf("VOTING DAY IS 30-04-2023\nVOTING TIME IS 10 AM TO 6PM\n");
	printf("PLEASE GIVE VOTE ON THE SCHEDULED DATE\n");
	vote();}
void vote()
{	struct voter v;
	int vote;
...
int main(){
	...
	case 1:
		system("cls");
		printf("\t\t\t\tWELCOME TO ONLINE VOTING REGISTRATION\n");
		printf("PLEASE ENTER YOUR NAME\n");
		scanf("%s",&v.name);
		printf("ENTER YOUR AGE\n");
		scanf("%d",&v.age);
		printf("ENTER A USERNAME(without special characters)\n");
		scanf("%s",&v.username);
